...
proj_dat <- raw_dat %>% 
  ...
  dplyr::select(Date, Cruise, SI, O2_uM, PO4_uM, NO3_uM, H2S_uM, Mean_NH4, Mean_NO2, Mean_N2, Mean_O2, Mean_co2, Mean_N2O, Mean_CH4, Temperature, Salinity, Density)

chemicals_of_interest <- proj_dat %>%
  dplyr::select(Date, O2_uM, NO3_uM, H2S_uM)
